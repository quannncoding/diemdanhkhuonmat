...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #background
        print(value_from_p1)
        img3 = PIL.Image.open(r"ImageFaceDetect\bg_new.png")
        ...
        #time_img = Label(self.root, image=self.photoimgtime, bg="#EBEBEB")
        #time_img.place(x=133, y=40, width=27, height=27)
        def time():
            string=strftime('%H:%M:%S %p')
            lbl.config(text=string)
            lbl.after(1000,time)

        lbl=Label(self.root,font=("yu gothic ui", 13, "bold"),bg="#EBEBEB", fg="black")
        lbl.place(x=110,y=35,width=100,height=20)
        time()
        lbl1 = Label(self.root,text=today, font=("yu gothic ui", 13, "bold"), bg="#EBEBEB", fg="black")
        lbl1.place(x=106, y=60, width=100, height=20)

        #====title=========
        self.txt = "ĐIỂM DANH BẰNG KHUÔN MẶT"
        self.count = 0
        self.text = ''
        self.color = ["#000000"]
        self.heading = Label(self.root, text=self.txt, font=("yu gothic ui", 26, "bold"), bg='#EBEBEB' , fg="black",
                             bd=5)
        self.heading.place(x=420, y=30, width=600)
        #self.slider()
        self.heading_color()
        ...
        time_img = Label(self.root, image=self.photoimgpeop, bg="#EBEBEB")
        time_img.place(x=1165, y=45, width=27, height=27)
        self.lblemail = Label(self.root,text=self.account, font=("yu gothic ui", 12, "bold"), bg="#EBEBEB", fg="green")
        self.lblemail.place(x=1200, y=48, width=100, height=22)
        ...
        b1 = Button(self.root, image=self.photoimglogout, cursor="hand2", command=self.exit,borderwidth=0,bg="#EBEBEB")
        b1.place(x=1350, y=45, width=27, height=27)

        b1_1 = Button(self.root, text="Đăng xuất", cursor="hand2", command=self.exit,
                      font=("times new roman", 13, "bold"),
                      bg="#EBEBEB", fg="black",borderwidth=0)
        ...
        b4 = Button(self.root, text="Lịch sử điểm danh", font=("yu gothic ui", 16, "bold"),command=self.attendance_data ,image=self.photobtn4,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
